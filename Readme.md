...
**Данный карткий курс по основам Go был подготовлен и аккуратно собран в формате книг Sams Teach Yourself C in 21 Days (которые мне очень нравятся) мной на основе плана и информации составленных ChatGPT и доработанных DeepSeek, а также, он не претендует на идеальный и правильный, также в <a http://10.0.0.105:3000/Obolensky-dev/Go_education/src/branch/master/Exercise">каталоге</a> содержатся примеры выполненных мной заданий**
